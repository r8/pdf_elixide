defmodule PdfElixide.Native do
  ...
  def document_bookmark_segments(_doc, _options), do: err()
  ...
  def document_export_form_data(_doc, _format, _file_spec), do: err()
  ...
  def editor_export_form_data(_editor, _format, _file_spec), do: err()
  ...
  def editor_info(_editor), do: err()
  def editor_set_info_field(_editor, _field, _value), do: err()
  def pdf_date_writable(_date), do: err()
  def editor_delete_page(_editor, _page_index), do: err()
  def editor_move_page(_editor, _from, _to), do: err()
  def editor_keep_pages(_editor, _pages), do: err()
  def editor_extract_pages(_editor, _pages), do: err()
  def editor_extract_page_ranges(_editor, _ranges), do: err()
  def editor_bookmark_segments(_editor, _options), do: err()
  def editor_split_by_bookmarks(_editor, _options), do: err()
  def editor_merge(_editor, _path), do: err()
  def editor_merge_bytes(_editor, _bytes), do: err()
  ...
  def editor_page_media_box(_editor, _page_index), do: err()
  def editor_page_crop_box(_editor, _page_index), do: err()
  def editor_set_page_media_box(_editor, _page_index, _rect), do: err()
  def editor_set_page_crop_box(_editor, _page_index, _rect), do: err()
  def editor_crop_margins(_editor, _margins), do: err()
  def editor_erase_regions(_editor, _page_index, _rects), do: err()
  def editor_clear_erase_regions(_editor, _page_index), do: err()
  def editor_mark_page_redactions(_editor, _page_index), do: err()
  def editor_mark_all_redactions(_editor), do: err()
  def editor_unmark_page_redactions(_editor, _page_index), do: err()
  def editor_is_page_marked_for_redaction(_editor, _page_index), do: err()
  def editor_redaction_count(_editor, _page_index), do: err()
